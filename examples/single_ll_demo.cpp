...
int main() {
    ...
    algosmith::LinkedList<int> emptyList;
    try {
    ...
    // ── Rule of Five demo ─────────────────────────────────────────────────
    algosmith::LinkedList<int> original;
    original.insertAtTail(1);
    original.insertAtTail(2);
    original.insertAtTail(3);

    algosmith::LinkedList<int> copied  = original;          // copy constructor
    algosmith::LinkedList<int> moved   = std::move(original); // move constructor
